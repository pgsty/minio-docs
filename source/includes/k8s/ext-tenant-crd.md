...
[MinIO Kubernetes Documentation](https://minio.pigsty.io/operations/deployments/kubernetes.html)。  
...
请参阅 <a
href="https://minio.pigsty.io/reference/operator-crd.html">MinIO
...
[MinIO Operator CRD](https://minio.pigsty.io/reference/operator-crd.html) 参考。  
...
请参阅 <a
href="https://minio.pigsty.io/reference/operator-crd.html#tenant">MinIO
Operator CRD</a> 参考。</p></td>
</tr>
<tr class="even">
<td style="text-align: left;"><p><strong><code>image</code></strong>
...
<p>有关为 MinIO 租户配置 TLS 的示例和更完整文档，
请参阅 <a
href="https://minio.pigsty.io/reference/operator-crd.html#tenantspec">MinIO
Operator CRD</a> 参考。</p></td>
</tr>
<tr class="odd">
<td
