...
#. Extract the object details from the incoming POST request.
   ...
   .. list-table::
      ...
      * - ``inputS3Url``
        - A `presigned URL <https://silo.pigsty.io/developers/go/API.html#presigned-operations>`__ for the original object.
...
#. Generate a `presigned URL <https://silo.pigsty.io/developers/go/API.html#presigned-operations>`__ for the original object.
...
The sample handler, written in Python, retrieves the target object using a `presigned URL <https://silo.pigsty.io/developers/go/API.html#presigned-operations>`__ generated by the caller.
