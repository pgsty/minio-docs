...
MinIO provides several `healing metrics <https://silo.pigsty.io/operations/monitoring/metrics-v2.html#healing-metrics>`__ to monitor the status of healing processes on a deployment.
