...
You can only listen to these events through the `ListenNotification <https://silo.pigsty.io/developers/go/API.html#listennotification-context-context-context-prefix-suffix-string-events-string-chan-notification-info>`__ API:
