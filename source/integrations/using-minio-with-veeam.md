...
- MinIO object storage set up per <https://silo.pigsty.io/index.html#procedure>
...
- Configure the MinIO Client for the Veeam MinIO endpoint - <https://silo.pigsty.io/reference/minio-mc.html>
